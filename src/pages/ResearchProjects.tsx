          ...
          {activeProject.stage === 'fullTimeSourceSelect' && (
            <div className="space-y-6">
              ...
              <SelectionQuestion
                ...
                options={['开启联网搜索', '关闭联网搜索']}
                selected={[activeProject.fullTimeSource.onlineSearch ? '开启联网搜索' : '关闭联网搜索']}
                onChange={(next) =>
                  updateProject(activeProject.id, (project) => ({
                    ...project,
                    fullTimeSource: {
                      ...project.fullTimeSource,
                      onlineSearch: next[0] === '开启联网搜索',
                    },
                  }))
                }
              />
