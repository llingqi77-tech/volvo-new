...
export default function App() {
  ...
  const [docs, setDocs] = useState<KnowledgeDoc[]>([
    ...
    // 原「整车知识库」演示文档归入行业知识库（MVP 不单独展示整车类别）
    { id: 'doc-16', title: 'Volvo EX90 智驾系统硬件拆解报告', type: 'PDF • 45.8 MB • 2024-11-20', tags: ['EX90', '智驾硬件'], uploader: '林索菲', color: 'text-gray-400', category: '行业知识库', summary: 'EX90搭载了Luminar激光雷达、8个摄像头、5个毫米波雷达和16个超声波雷达，构成了360度全方位感知系统。算力平台采用NVIDIA Orin芯片，算力达254 TOPS。', uploadDate: '2024-11-20', fileSize: '45.8 MB' },
    { id: 'doc-17', title: 'EX30 电池系统技术解析', type: 'PDF • 28.4 MB • 2024-11-18', tags: ['EX30', '电池'], uploader: '陈浩', color: 'text-gray-400', category: '行业知识库', summary: 'EX30采用宁德时代磷酸铁锂电池，容量69kWh，CLTC续航530km。电池包采用CTP技术，体积利用率提升15%，支持150kW快充，30%-80%充电时间26分钟。', uploadDate: '2024-11-18', fileSize: '28.4 MB' },
    { id: 'doc-18', title: 'XC90 Recharge 混动系统详解', type: 'PDF • 32.6 MB • 2024-11-15', tags: ['XC90', '混动'], uploader: '王建国', color: 'text-gray-400', category: '行业知识库', summary: 'XC90 Recharge采用2.0T发动机+电机的插电混动系统，综合功率455马力，纯电续航71km。能量回收系统和智能能量管理策略优化了燃油经济性。', uploadDate: '2024-11-15', fileSize: '32.6 MB' },
    { id: 'doc-19', title: 'SPA2平台架构技术白皮书', type: 'PDF • 52.3 MB • 2024-11-12', tags: ['SPA2', '平台'], uploader: '徐莱纳斯', color: 'text-gray-400', category: '行业知识库', summary: 'SPA2是沃尔沃第二代可扩展平台架构，专为纯电和混动车型设计。采用模块化设计，支持多种轴距和车身形式，集成度更高，重量更轻。', uploadDate: '2024-11-12', fileSize: '52.3 MB' },
    { id: 'doc-20', title: '主动安全系统City Safety技术解析', type: 'PDF • 38.7 MB • 2024-11-10', tags: ['安全', 'City Safety'], uploader: '吴梅', color: 'text-gray-400', category: '行业知识库', summary: 'City Safety是沃尔沃的主动安全系统，能识别车辆、行人、自行车和大型动物。通过摄像头和雷达融合，实现自动紧急制动，有效降低碰撞风险。', uploadDate: '2024-11-10', fileSize: '38.7 MB' },
    { id: 'doc-21', title: '空气悬架系统工作原理', type: 'PDF • 24.5 MB • 2024-11-08', tags: ['悬架', '舒适性'], uploader: '林峰', color: 'text-gray-400', category: '行业知识库', summary: '空气悬架系统通过调节空气弹簧的气压，实现车身高度和悬架硬度的动态调节。提供舒适、运动、越野等多种模式，适应不同路况和驾驶需求。', uploadDate: '2024-11-08', fileSize: '24.5 MB' },
    { id: 'doc-22', title: '车载信息娱乐系统架构设计', type: 'PDF • 41.2 MB • 2024-11-05', tags: ['车机', '娱乐'], uploader: '谢晓彤', color: 'text-gray-400', category: '行业知识库', summary: '基于Android Automotive OS的车载系统，采用高通骁龙8155芯片。支持5G连接、OTA升级、语音助手和丰富的第三方应用生态。', uploadDate: '2024-11-05', fileSize: '41.2 MB' },
    { id: 'doc-23', title: '热管理系统优化方案', type: 'PDF • 29.8 MB • 2024-11-02', tags: ['热管理', '续航'], uploader: '钱小芳', color: 'text-gray-400', category: '行业知识库', summary: '电动车热管理系统对续航和电池寿命至关重要。采用热泵空调、电池预加热和智能温控策略，冬季续航损失降低20%。', uploadDate: '2024-11-02', fileSize: '29.8 MB' },
    { id: 'doc-24', title: '车身轻量化技术应用', type: 'PDF • 35.4 MB • 2024-10-30', tags: ['轻量化', '材料'], uploader: '冯建国', color: 'text-gray-400', category: '行业知识库', summary: '通过铝合金车身、高强度钢和复合材料的应用，车身重量降低15%。轻量化设计在保证安全性的同时，提升了续航和操控性能。', uploadDate: '2024-10-30', fileSize: '35.4 MB' },
    { id: 'doc-25', title: '智能泊车系统技术方案', type: 'PDF • 26.9 MB • 2024-10-28', tags: ['泊车', '智能'], uploader: '袁梦', color: 'text-gray-400', category: '行业知识库', summary: '智能泊车系统支持平行、垂直和斜向泊车，以及记忆泊车功能。通过超声波雷达和环视摄像头，实现厘米级精准控制。', uploadDate: '2024-10-28', fileSize: '26.9 MB' },
    { id: 'doc-26', title: '电机与电控系统技术详解', type: 'PDF • 42.1 MB • 2024-10-25', tags: ['电机', '电控'], uploader: '韩磊', color: 'text-gray-400', category: '行业知识库', summary: '永磁同步电机配合SiC功率模块，效率达到96%。电控系统实现精准的扭矩控制和能量回收，提升了动力性能和续航表现。', uploadDate: '2024-10-25', fileSize: '42.1 MB' },
    { id: 'doc-27', title: '车联网V2X通信技术', type: 'PDF • 31.7 MB • 2024-10-22', tags: ['V2X', '车联网'], uploader: '蒋雨欣', color: 'text-gray-400', category: '行业知识库', summary: 'V2X技术实现车与车、车与基础设施的通信。支持红绿灯信息、前方事故预警和协同式自适应巡航，提升行车安全和效率。', uploadDate: '2024-10-22', fileSize: '31.7 MB' },
    { id: 'doc-28', title: '座舱声学设计与NVH优化', type: 'PDF • 27.3 MB • 2024-10-20', tags: ['NVH', '声学'], uploader: '罗文斌', color: 'text-gray-400', category: '行业知识库', summary: '通过主动降噪、声学玻璃和密封优化，座舱静谧性达到豪华车水准。电动车特有的低频噪音通过主动声浪补偿技术得到有效控制。', uploadDate: '2024-10-20', fileSize: '27.3 MB' },
    { id: 'doc-29', title: '可持续材料应用报告', type: 'PDF • 19.6 MB • 2024-10-18', tags: ['可持续', '材料'], uploader: '梁静茹', color: 'text-gray-400', category: '行业知识库', summary: '内饰采用再生塑料、天然纤维和环保皮革等可持续材料。25%的塑料来自回收材料，地毯使用100%再生PET纤维，符合北欧环保理念。', uploadDate: '2024-10-18', fileSize: '19.6 MB' },
    { id: 'doc-30', title: '充电系统兼容性测试报告', type: 'PDF • 22.8 MB • 2024-10-15', tags: ['充电', '兼容性'], uploader: '曾志伟', color: 'text-gray-400', category: '行业知识库', summary: '对国内主流充电桩品牌进行兼容性测试，支持国标GB/T和欧标CCS充电协议。充电握手成功率99.5%，兼容性表现优秀。', uploadDate: '2024-10-15', fileSize: '22.8 MB' },
